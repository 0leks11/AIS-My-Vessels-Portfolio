...
const ChatBot: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 w-[90vw] max-w-md max-h-[80vh] bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden flex flex-col z-50 md:w-[70%] lg:w-96 lg:h-[500px] lg:bottom-10 lg:right-10">
